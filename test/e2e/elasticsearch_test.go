...
import (
	...
	"github.com/galexrt/elasticsearch-operator/pkg/alertmanager"
	"github.com/galexrt/elasticsearch-operator/pkg/client/monitoring/v1alpha1"
	"github.com/galexrt/elasticsearch-operator/pkg/prometheus"
	testFramework "github.com/galexrt/elasticsearch-operator/test/e2e/framework"
...
func TestExposingPrometheusWithIngress(t *testing.T) {
	...
	ingress := testFramework.MakeBasicIngress(prometheusService.Name, 9200)
...
func isDiscoveryWorking(ns, prometheusName string) func() (bool, error) {
	return func() (bool, error) {
		...
		expectedTargets := []string{fmt.Sprintf("http://%s:9200/metrics", podIP)}
